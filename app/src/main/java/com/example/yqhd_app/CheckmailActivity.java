...
public class CheckmailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvdnotp = findViewById(R.id.tvdnotp);
        mbtntieptheo2 = findViewById(R.id.mbtntieptheo2);
        tvnhapotp = findViewById(R.id.tvnhanotp);
        medtmailotp = findViewById(R.id.edtmailotp);
                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        Toast.makeText(CheckmailActivity.this, "Vui lòng xác nhận gmail " + mUser.getEmail(), Toast.LENGTH_SHORT).show();
...
//                    }
        ...
        tvdnotp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(CheckmailActivity.this, DangNhapActivity.class);
                startActivity(intent);
            }
        });
    }
