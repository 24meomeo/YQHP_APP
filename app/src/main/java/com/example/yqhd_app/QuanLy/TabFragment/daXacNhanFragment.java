...
public class daXacNhanFragment extends Fragment implements DonHangAdapter.onClickItem{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.quanly_fragment_donhang_daxacnhan, container, false);
...
//
        recyclerView = v.findViewById(R.id.rcvDonHangDaXacNhan);
    ...
    public void onResume() {
        ...
        collectionReference.whereEqualTo("trangthai", 1).get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            @Override
