...
public class SanPhamAdapter extends RecyclerView.Adapter<SanPhamAdapter.ViewHolder>{
    ...
    SanPhamFragment khoFragment;
    onClickItem onClickItemListener;
    public SanPhamAdapter(Context context, List<SanPhamModel> list) {
        this.context = context;
        this.list = list;
    }
    public SanPhamAdapter(Context context, List<SanPhamModel> list, onClickItem onClickItemListener) {
        this.context = context;
        this.list = list;
        this.onClickItemListener = onClickItemListener;
    }
    public SanPhamAdapter(Context context, SanPhamFragment khoFragment, List<SanPhamModel> list) {
...
//                dialog.show();
                onClickItemListener.onClickGetInfo(item.getId(), item.getName(), item.getCategory()
                        , item.getPrice(), item.getDescription(), item.getImage());
...
//        medtdialogImage.setImageURI(imageUri);
    ...
    public interface onClickItem{
        ...
        void onClickGetInfo(String id, String name, String category, int price, String description
                , String image);
    }
    @Override
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView tenSanPham, giaSanPham, loaiSanPham, motaSanPham;
...
//        private SanPhamFragment khoFragment;
//
//        public ReProduct(SanPhamFragment khoFragment, Context context, Bundle bundle) {
//            super(context);
//            this.khoFragment = khoFragment;
