...
public class HomeFragment extends Fragment implements ItemFavouAdapter.onClickItem, ItemRcmAdapter.onClickItem {
    ...
    View v;
    String userID;
    String[] greetings = {"Hôm nay bạn thế nào?", "Cùng xem điện thoại nhé!", "Chào mừng trở lại!"};
...
//                List<DocumentSnapshot> randomDocuments = list.subList(2, Math.min(list.size(), 10));
    ...
    protected void loadItemHCandyData() {
        ...
        itHCandyFVreference.whereEqualTo("category", "sams").get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            @Override
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                List<DocumentSnapshot> list = queryDocumentSnapshots.getDocuments();
                Collections.shuffle(list);
        ...
        itHCandyRCMreference.whereEqualTo("category", "sams").get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            @Override
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                List<DocumentSnapshot> list = queryDocumentSnapshots.getDocuments();
                Collections.shuffle(list);
    ...
    protected void loadItemHCupCData() {
        ...
        itHCupCFVreference.whereEqualTo("category", "oppo").get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            @Override
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                List<DocumentSnapshot> list = queryDocumentSnapshots.getDocuments();
                Collections.shuffle(list);
...
//
        ...
        itHCupCRCMreference.whereEqualTo("category", "oppo").get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            @Override
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                List<DocumentSnapshot> list = queryDocumentSnapshots.getDocuments();
                Collections.shuffle(list);
    ...
    protected void loadItemHCroissData() {
        ...
        itHCroissFVreference.whereEqualTo("category", "ip").get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            @Override
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                List<DocumentSnapshot> list = queryDocumentSnapshots.getDocuments();
                Collections.shuffle(list);
        ...
        itHCCroissRCMreference.whereEqualTo("category", "ip").get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            @Override
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                List<DocumentSnapshot> list = queryDocumentSnapshots.getDocuments();
                Collections.shuffle(list);
